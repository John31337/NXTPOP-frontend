...
export const PaginationCtrl = () => {
  return (
    <Box py={"4px"} display={"flex"} flexDirection={["column", "column", "column", "column", "row"]} justifyContent={"space-between"} alignItems={"center"} gridGap={"16px"}>
      <Box display={"flex"} justifyContent={"center"} alignItems={"center"} flexWrap={"wrap-reverse"} gridGap={"5px"}>
        Page {1} of {2} | Go to page :&nbsp;
        <CustomInput type={"number"} width={"100px"} />
      </Box>
      <Box display={"flex"} justifyContent={"center"} alignItems={"center"} gridColumnGap={"16px"} gridRowGap={"5px"} flexWrap={"wrap"}>
