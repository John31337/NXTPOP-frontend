  ...
  return (
    <>
      ...
      <Box flexGrow={1} width={"100%"} overflow={"auto"} display={"flex"} flexDirection={"column"}>
        <Box p={"20px"} display={"flex"} gridGap={"20px"}>
          ...
          <Box flexGrow={1} display={"flex"} flexDirection={"column"}>
            ...
            <Box mt={"24px"} p={"16px"} background={"#222222"} border={"1px solid #333333"} borderRadius={"8px"} display={"flex"} gridGap={"12px"}>
              <Box mr={"auto"}>
            ...
            <Box my={"16px"} bg={"darkgray"} width={"100%"} height={"1px"} />
          </Box>
        </Box>
        <Box p={"20px"} display={"flex"} flexDirection={"column"} gridGap={"16px"}>
          <Collapse icon={<FourStarIcon />} title={"Price history"}>
            <Box width={"100%"} p={"12px"}>
              <Box bg={"black"} width={"100%"} pt={"20px"} border={"1px solid #333333"} borderRadius={"8px"} display={"flex"}>
                <Box pr={"12px"} color={"#777777"} textAlign={"center"} transform={"scale(-1)"} style={{ writingMode: "vertical-lr" }}>
                  Price (SOL)
                </Box>
  ...
  return (
    <AttrCardBase {...props}>
      <Box fontSize={"20px"} color={"#777777"} display={"flex"} alignItems={"center"} gridGap={"6px"}>
        <Box>{icon}</Box>
        <Box fontWeight={["600"]} fontSize={["12px"]} lineHeight={["16px"]}>
          {title}
        </Box>
      </Box>
      <Box fontWeight={["500"]} fontSize={["14px"]} lineHeight={["16px"]}>
        {children}
      </Box>
    </AttrCardBase>
  );
